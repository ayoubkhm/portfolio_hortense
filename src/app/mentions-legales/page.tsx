...
export default function MentionsLegalesPage() {
  const jsonLd = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://hortensederuidiaz.fr/mentions-legales#breadcrumb",
    "itemListElement": [
      { "@type": "ListItem", "position": 1, "name": "Accueil", "item": "https://hortensederuidiaz.fr" },
      { "@type": "ListItem", "position": 2, "name": "Mentions légales", "item": "https://hortensederuidiaz.fr/mentions-legales" },
    ],
  };
